...
void
UdpChannel::set_socket(Ptr<Socket> socket)
{
  m_socket = socket;
}
...
TorBktapApp::StartApplication (void)
{
  ...
  m_readbucket.SetRefilledCallback(MakeCallback (&TorBktapApp::refill_read_callback, this));
...
void
TorBktapApp::refill_read_callback (int64_t prev_read_bucket)
{
